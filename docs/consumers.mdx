...
import { registeredChannels, onChannelRegistered } from '@agora/diagnostics'
import type { DiagnosticEvent } from '@agora/diagnostics'
...
```ts
import diagnostics_channel from 'node:diagnostics_channel'
import { channelName } from '@agora/diagnostics'
import type { DiagnosticEvent } from '@agora/diagnostics'
